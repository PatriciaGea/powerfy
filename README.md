...
* **Language:** Kotlin
* **UI:** Jetpack Compose
* **Data source:** [DummyJSON](https://dummyjson.com/) (public REST API for prototyping)
...
**Why this structure:** it keeps networking and business logic independent of Compose, makes each screen testable in isolation, and mirrors the layering expected in professional Android codebases.
...
Product data comes from [DummyJSON](https://dummyjson.com/), a free REST API for prototyping.
...
> **Note:** DummyJSON is a test/prototyping API. Write operations (create, update, delete) are simulated and are not actually persisted on the server.
...
3. Run the app on an emulator or physical device (`Shift + F10`).

No API key or `.env` configuration is required — DummyJSON is a public, unauthenticated API.

## Roadmap

* [ ] Implement remaining 10 screens
* [ ] Persist cart/favorites locally (Room)
* [ ] Persist user session (DataStore)
...
* [Email](mailto:patricia.gea@gmail.com)
* [Portfolio](https://patriciageadev.vercel.app)
